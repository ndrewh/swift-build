...
public final class BuiltinMacros {
    ...
    public static let EXCLUDED_VARIANT_MATCHED_TARGET_DEPENDENCIES = BuiltinMacros.declareStringListMacro("EXCLUDED_VARIANT_MATCHED_TARGET_DEPENDENCIES")
    ...
    public static let SWIFT_DISABLE_COMPILATION_FOR_STATIC_LINKING_WHEN_ANY_TARGET_IS_PROMOTED_TO_DYNAMIC = BuiltinMacros.declareStringListMacro("SWIFT_DISABLE_COMPILATION_FOR_STATIC_LINKING_WHEN_ANY_TARGET_IS_PROMOTED_TO_DYNAMIC")
    ...
    private static let allBuiltinMacros = [
        ...
        EXCLUDED_VARIANT_MATCHED_TARGET_DEPENDENCIES,
